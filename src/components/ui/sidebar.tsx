...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "ml-3.5 flex min-w-0 flex-col gap-1 border-l border-sidebar-border pl-2.5 pr-1 py-0.5", // Changed mx-3.5 to ml-3.5, px-2.5 to pl-2.5 pr-1, removed translate-x-px
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
